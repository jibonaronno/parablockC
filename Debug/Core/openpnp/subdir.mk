...
C_SRCS += \
../Core/openpnp/openpnp.c 

OBJS += \
./Core/openpnp/openpnp.o 

C_DEPS += \
./Core/openpnp/openpnp.d 


# Each subdirectory must supply rules for building sources it contributes
Core/openpnp/%.o Core/openpnp/%.su Core/openpnp/%.cyclo: ../Core/openpnp/%.c Core/openpnp/subdir.mk
...
clean: clean-Core-2f-openpnp

clean-Core-2f-openpnp:
	-$(RM) ./Core/openpnp/openpnp.cyclo ./Core/openpnp/openpnp.d ./Core/openpnp/openpnp.o ./Core/openpnp/openpnp.su

.PHONY: clean-Core-2f-openpnp
